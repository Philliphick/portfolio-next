...
const page = () => {
  return (
    <div className='h-screen w-screen bg-gradient-to-br from-gray-800 via-gray-600 to-gray-800 text-white flex justify-center items-center align-middle'>
        ...
        <a href='https://github.com/Philliphick' target='_blank' className="border border-white px-4 py-2 hover:bg-black hover:text-white hover:border-black transition duration-300">GitHub</a>
        <a href="/CVPH.pdf" target="_blank" className="border border-white px-4 py-2 hover:bg-black hover:text-white hover:border-black transition duration-300">Resume</a>
        </div>
        {/* svg tech icon */}
