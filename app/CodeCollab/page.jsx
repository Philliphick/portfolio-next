      ...
      <div className="h-full">
        <section className="h-full w-full min-h-screen pt-16 bg-gradient-to-br from-black via-gray-900 to-cyan-500">
              ...
              <div className="w-10/12 md:w-6/12 lg:w-6/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg bg-gradient-to-b from-orange-500">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    ></svg>
                    <h4 className="text-xl font-bold text-white">CodeCollab</h4>
                    <p className="text-md font-light mt-2 text-white">
                      A platform designed to make collaboration among developers
                      easier. Post a project and find other developers to work
                      on it with you. Or find projects you can contribute to.
                    </p>
                    ...
                    <div className="relative flex flex-col min-w-0">
                      <div className="px-4 py-5 flex-auto">
                        ...
                        <p className="mb-4 text-blueGray-500">
                          As scrum master I worked with a team of 3 developers
                          over 4 weeks to develop this project. I was
                          responsible for managing the architecture of the
                          project, along with fullstack development.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="w-full md:w-6/12 px-4">
                    ...
                    <div className="relative flex flex-col min-w-0">
                      <div className="px-4 py-5 flex-auto">
                        ...
                        <p className="mb-4 text-blueGray-500">
                          JWT Authentication with Bcrypt hashing // User
                          profiles and contact functionality
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="w-screen flex flex-row gap-8 justify-center items-center mt-8">
            <a
              href="https://codecollab-client-sage.vercel.app/"
              target="_blank"
              className="bg-cyan-500 hover:bg-cyan-700 text-white text-center font-bold py-2 px-4 transition duration-300"
            >
              Visit
            </a>
            <a
              href="https://github.com/Philliphick/codecollab-client"
              target="_blank"
              className="bg-cyan-500 hover:bg-cyan-700 text-white text-center font-bold py-2 px-4  transition duration-300"
            >
              GitHub
